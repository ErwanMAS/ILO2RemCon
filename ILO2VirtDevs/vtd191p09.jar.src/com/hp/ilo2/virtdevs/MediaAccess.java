...
public class MediaAccess
{
  ...
  public int open(String paramString, int paramInt) throws IOException
  {
    ...
    this.zero_offset = 0;
    if (this.dev) {
      if (dio_setup != 0) { throw new IOException("DirectIO not possible (" + dio_setup + ")");
      }
      if (this.dio == null)
  ...
  public void read(long paramLong, int paramInt, byte[] paramArrayOfByte)
    throws IOException
  {
  ...
  public void write(long paramLong, int paramInt, byte[] paramArrayOfByte)
    throws IOException
  {
    paramLong += this.zero_offset;
    if (this.dev) {
  ...
  public int format(int paramInt1, int paramInt2, int paramInt3, int paramInt4, int paramInt5)
    throws IOException
  {
    if (this.dev) {
